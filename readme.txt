...
This plugin requires [Tutor LMS](https://wordpress.org/plugins/tutor/) with native ecommerce enabled. There are no settings screens to configure. After you activate the plugin, open the report and choose a country, year, and order statuses.

Documentation: [salesbystate.com](https://salesbystate.com/)

= How to use =

1. Install and activate Tutor LMS with native ecommerce enabled, then install and activate this plugin.
2. Go to **Tutor LMS → Sales by State**.
